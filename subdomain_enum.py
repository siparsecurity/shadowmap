...
def enumerate_subdomains(domain: str) -> list:
    ...
    # Active
    # Active brute-force disabled in Free version — available in ShadowMap Pro
    active_results = []
    console.print("[dim][!] Active brute-force not available in Free version — upgrade to Pro[/dim]")
